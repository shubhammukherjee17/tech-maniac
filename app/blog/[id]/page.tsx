                ...
                >
                  {blog.tags.map((tag, index) => (
                    <motion.span
                      ...
                      className="px-3 py-1.5 text-sm bg-white/10 backdrop-blur-xl text-white rounded-full border border-white/20 hover:bg-white/20 transition-all duration-300"
                    >
                      {tag}
                    </motion.span>
                  ))}
